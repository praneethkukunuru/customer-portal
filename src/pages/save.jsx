      ...
      axios
        ...
        .then((res) => {
          ...
          if (replies && replies.length > 0) {
            setChats((prevChats) =>
              prevChats.map((chat) => {
                const relevant = replies.filter((r) => r.thread_id === chat.id);
                if (relevant.length > 0) {
                  return { ...chat, messages: [...chat.messages, ...relevant] };
                }
                return chat;
              })
            );
    ...
    <div style={{ display: "flex", width: "100vw", height: "100vh", backgroundColor: "#f9f9f9" }}>
      ...
      >
        ...
        <button
          style={{
            width: "100%",
            backgroundColor: "#cbd5e1", // bluish gray
            color: "#000",
            padding: "12px",
            borderRadius: "8px",
            marginBottom: "16px",
      ...
      >
        ...
        >
          ...
          <div style={{ flex: 1, position: "relative", marginRight: "16px" }}>
            <input
              ...
              style={{
                width: "100%",
                padding: "8px 48px 8px 16px", // extra space on right if you want an icon
                borderRadius: "9999px", // round like Gmail
        ...
        {/* White, rounded card for the conversation */}
        <div
          style={{
            flex: 1,
            backgroundColor: "#fff",
                    ...
                    return (
                      ...
                      >
                        ...
                        <img
                          src={
                            msg.sender === "You"
                              ? user?.picture || "https://media.istockphoto.com/id/1223671392/vector/default-profile-picture-avatar-photo-placeholder-vector-illustration.jpg?s=612x612&w=0&k=20&c=s0aTdmT5aU6b8ot7VKm11DeID6NctRCpB755rA1BIP0="
                              : "/avatar.png"
                          }
                          alt="Avatar"
                          style={{
